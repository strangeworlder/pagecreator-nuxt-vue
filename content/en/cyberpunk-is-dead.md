---
title: 'Cyberpunk is Dead: Minimalist Sci-Fi RPG'
description: >-
...
::alert{type="warning" title="Mandatory Upgrades"}
...
::alert{type="caution" title="Breach of Contract"}
...
1.  **Burnout:** If you accumulate too much **Trauma** from stressful missions, you must roll. If you fail, your character simply **Removes themselves from the Team** and stops showing up. They are burned out and broken.
2.  **Redundancy:** The team has a **Profit** track. If the team's **Profit** reaches 10, and the team rolls a d12 result equal to or higher than **Profit**, the corporation reorganizes or outsources to a cheaper provider, and all characters are **Removed from the Team**.
...
::alert{type="tip" title="Pro-Tip for the Master's Toolbox"}
