...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/alvan/gogameu/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _ZNm2H7 = eventHandler(async (event) => {
...
const _XSf3z9 = eventHandler(async (event) => {
...
const handlers = [
  ...
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _ZNm2H7, lazy: false, middleware: false, method: undefined },
