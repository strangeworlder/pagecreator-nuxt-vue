---
title: 'Eevenkoto: Urbaani fantasiakampanjamaailma'
description: >-
  Eevenkoto on Legendoja & lohikäärmeitä -roolipeliin suunniteltu
  kampanjamaailma, jossa perinteinen fantasia kohtaa teollisen murroksen ja
  1920-luvun jazz-ajan urbaanin miljöön. Se päivittää L&L-säännöt 5.5e tasolle.
canonical: /eevenkoto
aliases:
  - /eevenkoto
...
isBasedOn:
  ...
  - type: Game
    ...
    id: 'https://dnd.wizards.com/resources/systems-reference-document'
...
faq:
  - q: Mikä on Eevenkoto?
    a: >-
      Eevenkoto on Legendoja & lohikäärmeitä -roolipeliä varten luotu
      kampanjamaailma, jossa yhdistyvät perinteinen fantasia, sotien jälkeinen
      1920-luvun jazz-ajan urbaani tunnelma ja teollinen maaginen murros.
  - q: Mihin sääntöjärjestelmään Eevenkoto pohjautuu?
    a: >-
      Maailma on kehitetty Legendoja & lohikäärmeitä (L&L) -järjestelmälle, ja
      se on täysin yhteensopiva maailman suosituimman roolipelin 5.5e (SRD
...
::alert{type="note" title="Kampanjamaailma yhdellä silmäyksellä"}
* **Miljöö**: Urbaani, teollistuva fantasiamaailma, verrattasissa meidän maailmamme 1920-lukuun
* **Systeemi**: L&L / 5.5e-yhteensopiva
* **Sävy**: Mystinen, urbaani, teollistuva, iloinen, janoinen
* **Julkaisija**: Kustannusosakeyhtiö Gogam
::

## Tarina ja miljöö

Eevenkoto on vapaakaupunki kauppareittien risteyskohdassa. Maailma on käynyt läpi massiivisen sodan, jossa jumalat ja näiden seuraajat kääntyivät toisiaan vastaan risteävien käsitystensä takia siitä, miten uusi teknologia, keinotekoiset "eetterisieltu" tulisi ottaa vastaan. Jumalat joutuivat alakynteen lopulta Maallisen kansojen yhdistyessä näitä vastaan, ja sodan seurauksena maailma on maallistunut. 

Seikkailijat Eevenkodon kaupungissa kohtaavat kaduilla, tunneleissa ja tehtaiden varjoissa mitä erikoisempia haasteita, ja kokevat seikkailujen rinnalla suuria tunteita ja yrittävät miettiä, mikä heille itselleen on tärkeintä.
...
**Mikä on Eevenkoto?**  
Eevenkoto on L&L-roolipeliä varten luotu kampanjamaailma ja sääntöpäivitys, jossa perinteinen fantasia yhdistyy sotien jälkeisen ilon ajan urbaaniin miljööseen ja teolliseen murrokseen.

**Mihin sääntöjärjestelmään Eevenkoto pohjautuu?**  
