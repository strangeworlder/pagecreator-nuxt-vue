...
::alert{type="info" title="A Personal Note"}
...
- [Download the rules (Google Docs)](https://docs.google.com/document/d/1VYxmFq2ik5Wszqpo6jYv5GJXKoBRw7rkeALg7PkYfH0/edit?usp=sharing)
::

## The Core Mechanic: Tarot
...
::alert{type="warning" title="Catastrophes"}
...
1.  **Accept Death:** Deliver a final speech or perform one last heroic action to save someone else.
2.  **Fight Fate:** Permanently burn a point of Dissonance to try and survive. This requires a Chaos check—if the GM's drawn card matches your intent, you live, but at a terrible narrative cost.
